...
public final class ThrowerListConfig {
    ...
    public static String remoteUrl = "https://raw.githubusercontent.com/YOUR_USERNAME/throwerlist/main/uuids.txt";
    ...
    public static void load() {
        ...
        try (Reader reader = Files.newBufferedReader(configFile)) {
            ...
            remoteUrl = props.getProperty(REMOTE_URL_PROP, "https://raw.githubusercontent.com/YOUR_USERNAME/throwerlist/main/uuids.txt");
